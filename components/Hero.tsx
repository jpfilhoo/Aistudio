...
import { ArrowRight, MessageSquare, Zap, Sparkles, MessageCircle } from 'lucide-react';
    ...
    <section className="relative pt-32 pb-20 md:pt-56 md:pb-40 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        <div className="relative z-10 text-center lg:text-left">
          {/* Badge flutuante com animação sutil */}
          ...
          <p className="text-lg md:text-xl text-gray-400 mb-12 max-w-lg mx-auto lg:mx-0 leading-relaxed font-light">
            Transforme conversas em faturamento. Centralize <span className="text-white font-medium">WhatsApp, Instagram e Facebook</span> em uma plataforma robusta, segura e aprovada pela Meta.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
            {/* Botão Primário Padronizado (igual ao head) */}
            <button className="group px-10 py-4 bg-brand text-white rounded-full font-bold text-lg flex items-center justify-center gap-3 transition-all glow-red hover:opacity-90 hover:scale-[1.02] active:scale-95 shadow-xl shadow-brand/20">
              Agendar Demonstração <ArrowRight className="group-hover:translate-x-2 transition-transform" />
            </button>
            {/* Botão Secundário Padronizado */}
            <button className="px-10 py-4 glass text-white rounded-full font-bold text-lg hover:bg-white/5 transition-all border border-white/10 hover:border-white/20">
        ...
        <div className="relative mt-20 lg:mt-0 flex items-center justify-center">
          ...
          <div className="relative z-10 w-full glass rounded-[3rem] p-3 border-brand/10 shadow-2xl animate-float">
            ...
            {/* Float Cards - Mobile Friendly com whitespace-nowrap */}
